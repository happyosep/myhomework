package kr.mjc.leeyosep.web.mvc.user;

import kr.mjc.leeyosep.web.dao.User;
import kr.mjc.leeyosep.web.dao.UserDao;
...
public class UserController {
    ...
    public void loginForm(HttpServletRequest request,
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/model2/user/login.jsp")
                .forward(request, response);
    }
    ...
    public void login(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() +
                    "/mvc/user/login?msg=Wrong email or password");
        }
    }
}
